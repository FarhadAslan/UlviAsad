...
export function AuthCard({ mode, onSubmit, loading, children, title, subtitle, onGoogleSignIn, googleLoading }: AuthCardProps) {
              ...
              {onGoogleSignIn && (
                <div className="mt-4">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div className="flex-1 h-px" style={{ background: "rgba(147,204,255,0.1)" }} />
                    <span className="text-xs" style={{ color: "rgba(147,204,255,0.35)" }}>və ya</span>
                    <div className="flex-1 h-px" style={{ background: "rgba(147,204,255,0.1)" }} />
                  </div>
                  ...
                  >
                    <div
                      className="relative h-10 rounded-xl flex items-center justify-center gap-2.5 font-medium text-sm transition-all duration-300 disabled:opacity-50"
                      style={{
                    ...
                    >
                      {googleLoading ? (
                        ...
                        <>
                          ...
                          Google ilə {mode === "login" ? "daxil ol" : "qeydiyyat"}
                        </>
                      )}
                    </div>
                  </motion.button>
